...
- [Architektur: MitM Daten-Aggregator](#architektur-mitm-daten-aggregator)
  - [Dokumenten-Lenkung](#dokumenten-lenkung)
  - [Inhaltsverzeichnis](#inhaltsverzeichnis)
  - [1. Einführung und Ziele](#1-einführung-und-ziele)
    - [Applikation Cority Data-Feed](#applikation-cority-data-feed)
  ...
  - [4. Querschnittliche Konzepte](#4-querschnittliche-konzepte)
    - [4.1 Sicherheit \& Datenschutz (Security by Design)](#41-sicherheit--datenschutz-security-by-design)
      - [4.1.1 Envelope Encryption (KEK/DEK)](#411-envelope-encryption-kekdek)
      - [4.1.2 Transportverschlüsselung (TLS)](#412-transportverschlüsselung-tls)
      - [4.1.3 Unveränderbares Audit-Log](#413-unveränderbares-audit-log)
...
Das C Data-Feed Systems ist die Bereitstellung von HR-Master-, Organisations- und Satndort-Daten für die C Health & Safety Suite Global App (APP-123456) für die Märkte DE/AT/ZA/HU/MX/UK.
...
| :---------------------- | :----------------------------------- | :----------------------------------------------------------------- |
| (ET) Architektur        | in Klärung, dep-5-I                  | Entsprechung der IT-Strategie.                                     |
| Sicherheitsbeauftragter | in Klärung, dep-15                   | Einhaltung von Sicherheitsstandards. Verschlüsselung von PII-Daten |
| Produktverantwortlicher | Chris S., dep-51; Dennis B., dep-514 | Einfache Wartung & Deployment                                      |
